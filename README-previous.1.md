...
- Starts March 31, 2025 20:00 UTC
...
Numbers with exponents greater than 4000 or less than -4000 are not within acceptable bounds for this library. 
...
- **Documentation:** https://github.com/thrackle-io/float128
...
| Chains the protocol will be deployed on | Ethereum,Arbitrum,Base,BSC,Polygon,Other,OptimismReach, any EVM chain needed.  |
...
We will include references to mathematical models within the repository. 

✅ SCOUTS: Please format the response above 👆 so its not a wall of text and its readable.

## Running tests

Install python & foundry. Run the following:
